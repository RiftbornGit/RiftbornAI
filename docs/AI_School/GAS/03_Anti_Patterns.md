...
**Do instead:** Use `get_gas_assets` to verify the authored asset surface, then `run_quick_playtest` and replication audits to prove runtime behavior on the current default public lane.
