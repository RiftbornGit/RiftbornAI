...
- Check [docs/README.md](README.md) for the shipped documentation map and [../README.md](../README.md) for the public product overview
- Use [READINESS_TRUTH.md](READINESS_TRUTH.md) and [../Bridge/toolbook/public_surface.json](../Bridge/toolbook/public_surface.json) for the current shipped tool-surface metadata
