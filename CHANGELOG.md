...
the current product contract, use [docs/CORE_PRODUCT_CONTRACT.md](docs/CORE_PRODUCT_CONTRACT.md).
...
- **Beta surface lock default `true`**: Every shipped build is locked to the 99-tool beta surface. Internal dev mode requires explicit `RIFTBORN_DEV_MODE=1` env var. The toggle is hidden from end users.
