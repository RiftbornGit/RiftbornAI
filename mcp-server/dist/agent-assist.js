...
const WORKFLOW_HINTS = {
    ...
    // Grass pipeline
    create_landscape_grass_type: "Next: add_grass_variety to add mesh varieties (grass, ferns, litter), then wire the grass type to the landscape material's LandscapeGrassOutput node via execute_python.",
    add_grass_variety: "Grass type updated. If not yet wired to the landscape material, use execute_python to connect LandscapeGrassOutput.",
    // Foliage
