...
function Test-RiftbornMcpRuntime {
    ...
    $oldAllowUnauth = $env:RIFTBORN_ALLOW_UNAUTHENTICATED_LOCAL
    $oldHost = $env:RIFTBORN_HOST
    try {
        $env:RIFTBORN_AUTH_TOKEN = ""
        $env:RIFTBORN_API_KEY = ""
        $env:RIFTBORN_DEV_TOKEN = ""
        $env:RIFTBORN_ALLOW_UNAUTHENTICATED_LOCAL = "1"
        $env:RIFTBORN_HOST = "127.0.0.1"
        ...
        $env:RIFTBORN_ALLOW_UNAUTHENTICATED_LOCAL = $oldAllowUnauth
        $env:RIFTBORN_HOST = $oldHost
    }
}
