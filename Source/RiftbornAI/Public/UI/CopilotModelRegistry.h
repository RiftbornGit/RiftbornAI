...
struct RIFTBORNAI_API FCopilotModelEntry
{
	 ...
	 *  `claude-code:opus-4-7` the underlying API model is `claude-opus-4-7`.
...
namespace RiftbornCopilotModels
{
	...
	/** True when the canonical model ID refers to the adaptive Auto picker. */
	RIFTBORNAI_API bool IsAutoModelId(const FString& ModelId);
