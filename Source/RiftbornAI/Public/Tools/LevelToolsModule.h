...
public:
    ...
    static FClaudeToolResult Tool_GetActorInfoPIE(const FClaudeToolCall& Call);
        ...
        // =========================================================================
        // Level Transition & Spawn Tools
        // =========================================================================

        /** Trigger a runtime level transition via UGameplayStatics::OpenLevel (requires active PIE) */
        static FClaudeToolResult Tool_OpenLevel(const FClaudeToolCall& Call);

        /** Place an APlayerStart actor at the given coordinates in the editor world */
        static FClaudeToolResult Tool_PlacePlayerStart(const FClaudeToolCall& Call);
