...
private:
	...
	void ExtractFallbackClassInfo(const FString& Content, const FString& FilePath);
	void ExtractFunctions(const FString& Content, FIndexedCppClass& ClassInfo);
	void ExtractProperties(const FString& Content, FIndexedCppClass& ClassInfo);
