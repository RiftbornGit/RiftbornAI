 ...
 */
enum class EEmbodiedAgentState : uint8
{
...
public:
    ...
    EEmbodiedAgentState GetState() const { return CurrentState; }
...
private:
    ...
    // Current state
    EEmbodiedAgentState CurrentState = EEmbodiedAgentState::Idle;
    ...
    // Internal methods
    void TransitionTo(EEmbodiedAgentState NewState);
