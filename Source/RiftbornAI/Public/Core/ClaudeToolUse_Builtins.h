...
public:
	...
	static FClaudeToolResult Tool_FindAnimationAssetsForTask(const FClaudeToolCall& Call);
	...
	static FClaudeToolResult Tool_ReadViewportCamera(const FClaudeToolCall& Call);
	static FClaudeToolResult Tool_FrameSceneInViewport(const FClaudeToolCall& Call);
	...
	static FClaudeToolResult Tool_EnablePlugin(const FClaudeToolCall& Call);
