 ...
 *  - Enhanced Input wiring (Move / Look / Jump) that binds to the project
 *    Input Mapping Context and Input Actions at /Game/Input/IMC_Default and
 *    /Game/Input/Actions/IA_{Move,Look,Jump} if those assets exist. Soft
 *    failure — if the assets are missing, the character still possesses
 *    cleanly, it just has no bound inputs.
 *
